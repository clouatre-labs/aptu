...
By default, the action reviews all changed files. Call-graph context is injected automatically when the prompt budget allows (see [PR Review with AST Context](#pr-review-with-ast-context) below).
