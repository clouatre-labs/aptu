...
| `.github/workflows/ios-build.yml` | push/PR (AptuKMP, Cargo.toml, src) | Build and test KMP Android app and Rust FFI bindings | Catches UniFFI binding regressions before merge |
