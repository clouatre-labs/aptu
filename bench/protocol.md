...
- **PR Review**: three recently merged aptu PRs

### Procedure

1. Run the measurement script on the current (pre‑#1103) codebase and record the sizes.
2. Apply the changes from PR #1103 (prompt compression).
