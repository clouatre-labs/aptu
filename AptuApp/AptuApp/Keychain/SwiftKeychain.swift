...
// The KeychainProvider protocol is generated by UniFFI in aptu_ffi.swift
// Since both files are compiled into the same module (AptuApp), the protocol
// is available without an explicit import
